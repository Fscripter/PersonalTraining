...
Exercises[0] = new Exercise('Calentamiento',120,'Img/Exercises/Calentamiento.png');
Exercises[1] = new Exercise('Cardio',30,'Img/Exercises/Cardio.gif');
Exercises[2] = new Exercise('Sentadillas',60,'Img/Exercises/Sentadilllas.png');
...
Exercises[5] = new Exercise('Hidratacion',90,'Img/Exercises/Descanso.png');
...
Exercises[9] = new Exercise('Descanso',120,'Img/Exercises/Descanso.png');
...
Exercises[15] = new Exercise('Hidratacion',90,'Img/Exercises/Hidratacion.png');
...
Exercises[19] = new Exercise('Fin Serie, Descansa',30,'Img/Exercises/Descanso.png');
